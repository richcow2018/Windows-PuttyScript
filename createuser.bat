	 ...
	 if %%a GTR 0 (
		if not %newusername%=="" ( 
			:: pscp.exe -i %privatekeypath% -pw %myselfpasswd% %myselfusername%@%%a:/home/%exportusername%/.ssh/* %keyfiletempfolder%
			 pscp.exe -P %portno% -i %privatekeypath% -pw %myselfpassphrase% %myselfusername%@%%a:/home/%newusername%/.ssh/* %keyfiletempfolder%
...
for %%a in (%listdiffport%) do (
	 if %%a GTR 0 (
		if not %newusername%=="" ( 
			:: pscp.exe -i %privatekeypath% -pw %myselfpasswd% %myselfusername%@%%a:/home/%exportusername%/.ssh/* %keyfiletempfolder%
			 pscp.exe -P %diffportno% -i %privatekeypath% -pw %myselfpassphrase% %myselfusername%@%%a:/home/%newusername%/.ssh/* %keyfiletempfolder%
...
echo sudouser="%sudouser%" >> %tempuserscript%
echo privatekey="%privatekey%" >> %tempuserscript%
echo switch="off" >> %tempuserscript%
